...
function concatStyles(content, rootPath) {
  let assets = parseImports(content, rootPath);

  // Reverse asset list so we start with the last. This makes
  // sure we don't invalidate the start index's for each import.
